...
export const ManageOrganizer = () => {
  ...
  const fetchOrganizer = async () => {
    try {
      ...
      if (getOrganizer.data.AllOrganizer) {
        ...
        setAllOrganizer(getOrganizer.data.AllOrganizer);
      }
    } catch (error) {
  ...
  return (
    <section className=".container-fluid p-0 " id="ManageOrganizer-Main-Parent">
      <div className="p-0" id="ManageOrganizer-Heading">
        <p>Manage Organizer</p>
      </div>
      <div
        className="w-100 d-flex  justify-content-end align-items-center p-3"
        id="ManageOrganizer-Search-box"
      >
        ...
        <div className="d-flex justify-content-center align-items-center position-relative ">
          ...
          />
          <p className="position-absolute  " id="ManageOrganizer-Search-Icon">
            <FaSearch />
          </p>
        </div>
      </div>
      <div className="row p-0 m-0" id="ManageOrganizer-second-Parent">
        <div
          className="col-12 p-0 m-0"
          class="table-responsive"
          id="manageOrganizer-First-child"
        >
          { allOrganizer.length===0? < div id="Accepted-Organizer-Message" >
              <p id="page-logo"  >No Organizer found </p>
              </div>  :
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              {allOrganizer
                .filter((Items) => {
                  return searchOrganizer.toLowerCase() === ""
                    ? Items
